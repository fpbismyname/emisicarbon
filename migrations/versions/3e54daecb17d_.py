...
Revision ID: 3e54daecb17d
Revises: 
Create Date: 2025-01-07 12:23:09.105229
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('admin', 'company', 'user', name='user_role'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
